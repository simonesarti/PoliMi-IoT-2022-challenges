...
typedef uint16_t ch4C$Read$val_t;
typedef TMilli ch4C$MilliTimer$precision_tag;
...
typedef TMilli /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$precision_tag;
typedef uint16_t /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void ch4C$SplitControl$startDone(error_t error);
#line 138
static void ch4C$SplitControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void ch4C$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void ch4C$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void ch4C$Read$readDone(error_t result, ch4C$Read$val_t val);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void ch4C$MilliTimer$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );
# 62 "/opt/tinyos-main-2.1.2/tos/interfaces/Init.nc"
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t ch4C$SplitControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t ch4C$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t ch4C$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static error_t ch4C$Read$read(void );
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void ch4C$MilliTimer$startPeriodic(uint32_t dt);
#line 78
static void ch4C$MilliTimer$stop(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t ch4C$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool ch4C$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 27 "ch4C.nc"
message_t ch4C$packet[1000];
uint8_t ch4C$counter[1000];
uint8_t ch4C$x[1000];
bool ch4C$locked[1000];
uint8_t ch4C$dest[1000];
uint8_t ch4C$n_received_acks[1000];

static inline void ch4C$sendReq(void );
static inline void ch4C$sendResp(void );
static void ch4C$sendPacket(uint8_t msg_type, uint16_t value);
...
static inline void ch4C$Boot$booted(void );





static inline void ch4C$SplitControl$startDone(error_t err);
#line 116
static inline void ch4C$SplitControl$stopDone(error_t err);




static inline void ch4C$MilliTimer$fired(void );
#line 142
static void ch4C$AMSend$sendDone(message_t *buf, error_t err);
#line 193
static inline message_t *ch4C$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 225
static inline void ch4C$Read$readDone(error_t result, uint16_t data);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt);
# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
static void /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void );
# 18 "FakeSensorP.nc"
static inline error_t /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read(void );





static inline void /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired(void );
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(uint32_t dt){
#line 73
...
#line 18
{
  /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$startOneShot(10);
  return SUCCESS;
}

# 55 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static error_t ch4C$Read$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$read();
#line 55
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static uint8_t ch4C$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 193
{
  ...
  if (len != sizeof(my_msg_t )) {
      sim_log_error(172U, "message", "failed to read the content of the received message\n");
      return buf;
    }
  else {
      my_msg_t *rcm = (my_msg_t *)payload;

      sim_log_debug(173U, "radio_rec", "Received packet at time %s\n", sim_time_string());
      sim_log_debug(174U, "radio_pack", ">>>Pack \n \t Payload length %u \n", ch4C$Packet$payloadLength(buf));

      sim_log_debug_clear(175U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(176U, "radio_pack", "\t\t counter: %u \n", __nesc_ntoh_uint8(rcm->counter.nxdata));
      sim_log_debug_clear(177U, "radio_pack", "\t\t value: %u \n", __nesc_ntoh_uint16(rcm->value.nxdata));
      sim_log_debug_clear(178U, "radio_pack", "\t\t msg_type: %u \n", __nesc_ntoh_uint8(rcm->msg_type.nxdata));



      if (__nesc_ntoh_uint8(rcm->msg_type.nxdata) == 1) {

          ch4C$counter[sim_node()] = __nesc_ntoh_uint8(rcm->counter.nxdata);
          ch4C$sendResp();
        }
    }
...
#line 78
    case 6:
#line 78
      __nesc_result = ch4C$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t ch4C$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void ch4C$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      sim_log_debug(156U, "radio", "Radio ON on node %u!\n", TOS_NODE_ID);
      if (TOS_NODE_ID == 1) {
          sim_log_debug(157U, "timer", "Started timer on mote1\n");
          ch4C$MilliTimer$startPeriodic(1000);
        }
    }
  else {
      sim_log_error(158U, "radio", "Radio failed to start on node %u, retrying...\n", TOS_NODE_ID);
      ch4C$SplitControl$start();
    }
}
...
#line 113
  ch4C$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 116
{
  sim_log_debug(159U, "radio", "Radio on mote %u stopped!\n", TOS_NODE_ID);
}
...
#line 138
  ch4C$SplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  ch4C$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74e8088, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74e8088) {
#line 100
    case 0U:
#line 100
      /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74e8088, msg, error);
#line 100
      break;
#line 100
    }
...
#line 121
{
  ...
  ch4C$counter[sim_node()]++;
  sim_log_debug(160U, "timer", "\n\nTimer fired, counter is %hu.\n", ch4C$counter[sim_node()]);

  if (ch4C$locked[sim_node()]) {
      sim_log_debug(161U, "radio_send", "Radio on mote1 is locked, when timer fired, do nothing\n");
      return;
    }
  else {
      sim_log_debug(162U, "radio_send", "Radio on mote1 not locked, sending the request\n");
      ch4C$sendReq();
    }
}
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 225
{
  ...
  ch4C$sendPacket(2, data);
}

# 63 "/opt/tinyos-main-2.1.2/tos/interfaces/Read.nc"
inline static void /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(error_t result, /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t val){
#line 63
  ch4C$Read$readDone(result, val);
#line 63
}
#line 63
# 24 "FakeSensorP.nc"
...
#line 24
{
  /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16());
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb736ac70){
#line 83
  switch (arg_0xb736ac70) {
#line 83
    case 0U:
#line 83
      ch4C$MilliTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      /*ch4AppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Timer0$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb736ac70);
#line 83
      break;
#line 83
    }
...
inline static void * ch4C$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t ch4C$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 59
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74e8a70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74e8a70, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t ch4C$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*ch4AppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
inline static bool ch4C$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
# 78 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void ch4C$MilliTimer$stop(void ){
#line 78
...
#line 39
{
  ...
  my_msg_t *rcm = (my_msg_t *)ch4C$Packet$getPayload(&ch4C$packet[sim_node()], sizeof(my_msg_t ));

#line 51
  if (rcm == (void *)0) {
      sim_log_error(148U, "message", "failed to create the message\n");
      return;
    }

  __nesc_hton_uint8(rcm->counter.nxdata, ch4C$counter[sim_node()]);
  __nesc_hton_uint16(rcm->value.nxdata, value);
  __nesc_hton_uint8(rcm->msg_type.nxdata, msg_type);
  sim_log_debug(149U, "message", "inserting COUNTER:%u VALUE:%u, MSG_TYPE:%u into the message to be sent\n", __nesc_ntoh_uint8(rcm->counter.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata), __nesc_ntoh_uint8(rcm->msg_type.nxdata));


  ch4C$PacketAcknowledgements$requestAck(&ch4C$packet[sim_node()]);
  sim_log_debug(150U, "message", "Setting ack flag for the message\n");


  if (TOS_NODE_ID == 1) {
#line 66
    ch4C$dest[sim_node()] = 2;
    }
  else {
#line 67
    ch4C$dest[sim_node()] = 1;
    }
#line 68
  sim_log_debug(151U, "message", "message will be sent from mote%u to mote %u\n", TOS_NODE_ID, ch4C$dest[sim_node()]);

  if (ch4C$AMSend$send(ch4C$dest[sim_node()], &ch4C$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(152U, "radio_send", "Sending packet from %u to %u", TOS_NODE_ID, ch4C$dest[sim_node()]);
      ch4C$locked[sim_node()] = TRUE;
      sim_log_debug_clear(153U, "radio_send", " at time %s \n", sim_time_string());
      sim_log_debug(154U, "radio", "radio on mote%u has been locked\n", TOS_NODE_ID);
    }
}
...
#line 142
{
  ...
  if (err != SUCCESS) {
      sim_log_error(163U, "radio_send", "Packet sending from mote%u failed to be sent\n", TOS_NODE_ID);
    }
  else {
      sim_log_debug(164U, "radio_send", "Packet sending from mote%u sent correctly\n", TOS_NODE_ID);

      ch4C$locked[sim_node()] = FALSE;
      sim_log_debug(165U, "radio", "radio on mote%u has been unlocked\n", TOS_NODE_ID);

      {

        my_msg_t *rcm = (my_msg_t *)ch4C$Packet$getPayload(buf, sizeof(my_msg_t ));

#line 158
        if (rcm == (void *)0) {
            sim_log_error(166U, "message", "failed to parse the sent message in sendDone\n");
            return;
          }



        if (!ch4C$PacketAcknowledgements$wasAcked(buf)) {
            if (TOS_NODE_ID == 2) {
                sim_log_debug(167U, "radio_ack", "ack not received by mote%u, trying to send packet again\n", TOS_NODE_ID);
                ch4C$sendPacket(__nesc_ntoh_uint8(rcm->msg_type.nxdata), __nesc_ntoh_uint16(rcm->value.nxdata));
              }
            else {
                sim_log_debug(168U, "radio_ack", "ack not received by mote%u, waiting for next timer cycle to resend\n", TOS_NODE_ID);
              }
          }
        else 

          {
            sim_log_debug(169U, "radio_ack", "ack received by mote%u\n", TOS_NODE_ID);
            if (TOS_NODE_ID == 1) {
                ch4C$n_received_acks[sim_node()]++;
                sim_log_debug(170U, "radio_ack", "number of REQ_ACK received is %u\n", ch4C$n_received_acks[sim_node()]);
                if (ch4C$n_received_acks[sim_node()] == ch4C$x[sim_node()]) {
                    ch4C$MilliTimer$stop();
                    sim_log_debug(171U, "timer", "stopping timer\n");
                  }
              }
          }
      }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module ch4C */
  if (!strcmp(varname, "ch4C$packet"))
  {
    *addr = (uintptr_t)&ch4C$packet[__nesc_mote];
    *size = sizeof(ch4C$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ch4C$counter"))
  {
    *addr = (uintptr_t)&ch4C$counter[__nesc_mote];
    *size = sizeof(ch4C$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ch4C$x"))
  {
    *addr = (uintptr_t)&ch4C$x[__nesc_mote];
    *size = sizeof(ch4C$x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ch4C$locked"))
  {
    *addr = (uintptr_t)&ch4C$locked[__nesc_mote];
    *size = sizeof(ch4C$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ch4C$dest"))
  {
    *addr = (uintptr_t)&ch4C$dest[__nesc_mote];
    *size = sizeof(ch4C$dest[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ch4C$n_received_acks"))
  {
    *addr = (uintptr_t)&ch4C$n_received_acks[__nesc_mote];
    *size = sizeof(ch4C$n_received_acks[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module ch4C */
  memset((void *)&ch4C$packet[__nesc_mote], 0, sizeof ch4C$packet[__nesc_mote]);
  ch4C$counter[__nesc_mote] = 0;
  ch4C$x[__nesc_mote] = 7;
  memset((void *)&ch4C$locked[__nesc_mote], 0, sizeof ch4C$locked[__nesc_mote]);
  ch4C$dest[__nesc_mote] = 1;
  ch4C$n_received_acks[__nesc_mote] = 0;
